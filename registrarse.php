...
//mysqli("sql4.freemysqlhosting.net", "sql4499513", "YJim2lFDE", "sql4499513");
...
function sendMail($usuario, $sha1, $myObj)
{
    ...
    $ContrasenaDelCorreo = 'bvjxtgtalotdcbkm'; // SMTP password
    $SendFromEMAIL = 'ericcasanova.m@gmail.com'; // SMTP username
    $QuienLoEnviaNAME = 'moderator';
    $SendFromEMAILreply = 'ericcasanova.m@gmail.com';
    ...
    $Asunto = "ninguno";
    $BodyHTML = '<h1>hola x </h1> <br /><a href="http://' . $_SERVER['HTTP_HOST'] . '/new_user.php?id=' . $usuario->id . '&clave=' . $sha1 . '"><b>' . $sha1 . '</b></a>';
